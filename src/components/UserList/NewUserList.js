...
componentDidMount: ефект спрацює тільки при монтуванні компоненти у DOM-дерево

useEffect(() => {
    // тут можуть бути запити на сервер або якась ще інша асинхронщина
}, []);

componentDidMount && componentDidUpdate: ефект спрацює при монтуванні компоненти у DOM-дерево і ефект буде спрацьовувати кожного разу, коли буде змінюватись залежність, яку ми передали у масиві залежностей
